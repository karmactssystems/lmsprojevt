...
urlpatterns = [
    ...
    path('feedbacks', views.feedback, name='feedback-page'),
    path('manage_book',views.manage_book,name='manage-book'),
    path('manage_review', views.manage_review,name='manage-review'),
    path('manage_feedback', views.manage_feedback,name='manage-feedback'),
    ...
    path('manage_feedback/<int:pk>', views.manage_feedback,name='manage-feedback-pk'),
    path('view_book/<int:pk>',views.view_book,name='view-book-pk'),
    path('view_review/<int:pk>', views.view_review,name='view-review-pk'),
    path('view_feedback/<int:pk>', views.view_feedback,name='view-feedback-pk'),
    ...
    path('delete_feedback/<int:pk>', views.delete_feedback,name='delete-feedback'),
