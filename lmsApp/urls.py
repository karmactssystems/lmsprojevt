...
urlpatterns = [
    ...
    path('create_review_neo/<str:teaching_uid>/', views.create_review_neo, name='create_review_neo'),
    ...
    path('create_feedback_neo/<str:teaching_uid>/', views.create_feedback_neo, name='create_feedback_neo'),
